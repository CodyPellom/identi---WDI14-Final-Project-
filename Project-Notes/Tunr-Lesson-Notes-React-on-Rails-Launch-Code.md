...
39)  
ALso, with heroku make sure that after you do all of the heroku notes you read here and complete them all, you stil need to do a 

git add -A
git commit -m "message here"
git push heroku master

Personally, I only remmebr to do this to github, (which is initialized in a seperate folder) but you have to make sure to also do this in the root folder of your tunr application. or else heroku will not be updated with the buildpacks, the fixes etc. and hench, it WILL NOT FIRE OFF AND WORK. make sure to commit add and push often


* REACT (Front of da house) NOTES

40)

 cd into client,and in the terminal, we are going to run:

 npm install styled-components


 This will enable us to do some quick and easy styling withing components themselves. 

 41) go ahead and also:

 npm install react-router-dom



 this will enble seamless navigation and help us create different "pages" inside this single-page app. You can call them views, or pages. 

 42)  On your app.js, within clients:
  ...
  render() {
    return (
     ...
     <h1>Tunr</h1>
      ...
      <Route exact path="/artist/:id" component={SingleArtistView} />
      </Switch>
      </Router>
    );
  }
...
From this point on, these notes go into state and props within react. They will continue to be numbered so try to stick with me on this. I will do the best I can to create a break down as far as Ican go with the complex subject matter of react's state and props to finish up this app... see you in client. 
