...
My choice of React and Rails OR a MERN stack App (Node, Express etc)

I choose React on Rails. Better for routing and quicker setup.

Get working on the ERDs, User Stories, and Wire Frames. Many to Many documentation is in the official Rails Docs.

Identify what you need to accomplish to meet project expectations, and identify eveything else as a stretch goal. 

Models: One should represent a User. Two others should represent the main functional idea of your app. At least one Model/Resource needs to have full CRUD. In this case it will be the Correspondence Database Files. 

Devise is an icebox goal. Here is a good link on devise auth tokens, in case Ihappen to get there: https://github.com/lynndylanhurley/devise_token_auth/wiki/Setup-migrations-for-an-existing-User-table


Once React and Rails is put together, deploy Heroku immediently, and deploy early, deploy OFTEN or else there will bea shitload of problems 15 minutes before we present




rails g scaffold Users name id 


when i scaffld make sure I look at the controller, routes and models. The controler is largely the part that will give you the most trouble . 